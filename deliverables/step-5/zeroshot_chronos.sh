#!/usr/bin/env bash
# Re-written to run all seven datasets and multiple horizons.
...
# Same dataset family used in the paper
datasets=(
  "ETTh1"
  "ETTh2"
  "ETTm1"
...
for pred_len in "${pred_lens[@]}"; do
  # one output file per horizon
  filename="zeroshot_chronos_pred_${pred_len}.txt"
